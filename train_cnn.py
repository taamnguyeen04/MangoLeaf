...
def get_args():
    ...
    parser.add_argument("--data_path", "-d", type=str, default=r"C:\Users\tam\Documents\Data\MangoLeafBD Dataset", help="path to the dataset")
...
def train(args):
    ...
    train_dataset = ImageFolder(root=args.data_path, transform=transform)
    ...
    test_dataset = ImageFolder(root=args.data_path, transform=transform)
